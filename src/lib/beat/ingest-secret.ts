/** Header-only Beat ingest auth. Never accept or log the secret from the URL. */

export const INGEST_SECRET_URL_ERROR = "Send the secret as a header, not the URL.";
export const INGEST_SECRET_MISSING_ERROR =
  "Missing secret. Send Authorization: Bearer <secret> or X-Keystone-Secret.";
export const INGEST_SECRET_DENIED_ERROR = "Beat ingest is not enabled, or the secret is wrong.";
